...
echo '{"jsonrpc": "2.0", "id": 1, "method": "initialize", "params": {"protocolVersion": "2024-11-05", "capabilities": {}, "clientInfo": {"name": "test-client", "version": "1.0.0"}}}' | uv run python 2_weather_mcp_server.py 2>/dev/null | jq -c
...
} | uv run python 2_weather_mcp_server.py 2>/dev/null | jq -c
